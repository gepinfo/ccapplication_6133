...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#htmlFormservices" data-toggle="collapse" data-parent="#MainMenu">formservices <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="formservices">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/createform'>createform</a>
                                        
<a id="i9imej" className="gpd-text" href='/getallform'>getallform</a>
                                        
<a id="i9imej" className="gpd-text" href='/updateform'>updateform</a>
                                        
<a id="i9imej" className="gpd-text" href='/searchupdateform'>searchupdateform</a>
