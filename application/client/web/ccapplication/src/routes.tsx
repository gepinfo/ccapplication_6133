...
{ path : '/createform', component: lazy(()=>import('./app/createform/createform')) },
{ path : '/getallform', component: lazy(()=>import('./app/getallform/getallform')) },
{ path : '/updateform', component: lazy(()=>import('./app/updateform/updateform')) },
{ path : '/searchupdateform', component: lazy(()=>import('./app/searchupdateform/searchupdateform')) },
